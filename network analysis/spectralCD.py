...
def communities(g, kmax, projection_on_smaller_class = True, scaler = StandardScaler()):
    """
        Constructor
    ...
    fielder_vec = np.matmul(np.sqrt(I),V[:,1]) # the fieldere vector is the second eigenvector ov V
